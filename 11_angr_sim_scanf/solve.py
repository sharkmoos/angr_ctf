...
def main(argv):
  ...
  if simulation.found:
    ...
    stored_solutions = solution_state.globals['solution']

    solution = f'{solution_state.solver.eval(stored_solutions[0])} {solution_state.solver.eval(stored_solutions[1])}'
